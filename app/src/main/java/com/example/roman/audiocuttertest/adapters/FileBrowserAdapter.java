...
public class FileBrowserAdapter extends RecyclerView.Adapter<FileBrowserAdapter.ViewHolder> {
    ...
    private ArrayList<AudioDetector.Wrap> mDataset;
    ...
    public FileBrowserAdapter(ArrayList<AudioDetector.Wrap> myDataset) {
        mDataset = myDataset;
    }
    ...
    public void updateWithSearchQuery(String query){
        Iterator<AudioDetector.Wrap> iterator = mDataset.iterator();

        Log.d("SIZE",""+mDataset.size());
        AudioDetector.Wrap wrap;
    ...
    public void swap(ArrayList<AudioDetector.Wrap> datas) {
